...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/java.assets/shallow&amp;deep-copy.png" alt="拷贝类型" tabindex="0" loading="lazy"><figcaption>拷贝类型</figcaption></figure>
