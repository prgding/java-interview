...
<li>自我介绍</li>
<li>项目相关</li>
<li>Spring 和 Spring Boot 的区别</li>
<li>左连接和右连接区别</li>
<li>Spring 的 AOP 原理</li>
...
<li>讲讲 JWT 登陆和身份认证</li>
<li>哪里用到了 Redis 缓存？</li>
<li>怎样实现 Redis 数据一致性的？</li>
</ol>
<h4 id="根据技能" tabindex="-1"><a class="header-anchor" href="#根据技能" aria-hidden="true">#</a> 根据技能</h4>
<ol>
<li>讲讲面向对象</li>
<li>Java 常用的集合以及实现类</li>
<li>ArrayList, LinkedList, Vector 之间的区别</li>
<li>ArrayList 的默认大小</li>
<li>说说 Java 多线程</li>
<li>关于线程池的参数，创建线程池的时候需要注意什么？可不可以不指定？不指定的话存在什么问题？</li>
<li>源码看过吗？</li>
<li>讲讲 Spring 的事务</li>
<li>MySQL 了解多少？</li>
<li>为什么在深圳？</li>
...
<h3 id="上海卓临" tabindex="-1"><a class="header-anchor" href="#上海卓临" aria-hidden="true">#</a> 上海卓临</h3>
<ol>
<li>自我介绍</li>
...
<li>内连接和外连接有什么区别？</li>
<li>Redis 了解多少？</li>
<li>一条 SQL 语句的执行过程</li>
<li>抽象类和普通类有什么区别？</li>
<li>线程和进程的区别？</li>
<li>有了进程为什么还要有线程？</li>
</ol>
<h3 id="谷川联行一面-说是过了一面之后会有二面" tabindex="-1"><a class="header-anchor" href="#谷川联行一面-说是过了一面之后会有二面" aria-hidden="true">#</a> 谷川联行一面（说是过了一面之后会有二面）</h3>
<ol>
<li>自我介绍</li>
<li>MySQL
<ul>
...
<li>幻读和脏读的区别是什么？</li>
<li>解释一下 MVCC? 你觉得你的项目有哪个点可以用到？</li>
</ul>
</li>
<li>Redis
<ul>
<li>Redis 都有哪些数据类型？你项目中用到了哪种？</li>
<li>你项目中用 Redis 做缓存是基于什么考量呢？</li>
<li>缓存穿透和雪崩的区别是什么？怎么避免缓存雪崩？</li>
</ul>
</li>
<li>RabbitMQ
<ul>
<li>用过 RabbitMQ 吗？说说你对 RabbitMQ 的了解</li>
<li>RabbitMQ 的工作机制了解吗？</li>
</ul>
</li>
<li>数据结构
<ul>
<li>说一下链表，数组，B 树，B+树</li>
<li>B+树的局限性</li>
</ul>
</li>
<li>设计模式
...
<li>用过哪些分布式应用</li>
<li>分布式锁的使用场景</li>
<li>ThreadLocal 怎么保证集群下的数据一致性</li>
<li>为什么要用消息队列做异步处理</li>
<li>如何保证消息队列被全部消费</li>
<li>ThreadLocal 多线程之间传递</li>
<li>了解一些测试工具嘛</li>
<li>问我 base 意向</li>
</ol>
<h3 id="连连支付" tabindex="-1"><a class="header-anchor" href="#连连支付" aria-hidden="true">#</a> 连连支付</h3>
<ol>
<li>讲一下项目</li>
<li>讲下 Redis 的缓存穿透击穿雪崩</li>
<li>Redis 为什么快?</li>
<li>Dubbo 框架有了解过吗?</li>
...
<li><RouterLink to="/framework/spring.html#spring-%E4%BA%8B%E5%8A%A1%E6%9C%89%E5%93%AA%E5%87%A0%E7%A7%8D%E4%BC%A0%E6%92%AD%E8%A1%8C%E4%B8%BA">Spring 事务有哪几种传播行为</RouterLink></li>
